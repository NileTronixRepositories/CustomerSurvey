...
namespace CustomerSurvey.infrastructure.Migrations
{
    ...
    [Migration("20260607112651_AddPasswordLifecycleToApplicationUser")]
    partial class AddPasswordLifecycleToApplicationUser
    {
        /// <inheritdoc />
                    ...
                    b.ToTable("AnonymousTemplateCustomInput", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_AnonymousTemplateCustomInput_StartWith_StringOnly", "([Type] = 1) OR ([StartWith] IS NULL)");
                    ...
                    b.ToTable("TemplateCustomInput", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_TemplateCustomInput_StartWith_StringOnly", "([Type] = 1) OR ([StartWith] IS NULL)");
