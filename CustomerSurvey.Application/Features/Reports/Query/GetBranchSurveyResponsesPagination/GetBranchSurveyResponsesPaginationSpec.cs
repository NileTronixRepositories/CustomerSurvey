    ...
    : Specification<SurveyResponse, BranchSurveyResponsePaginationItemResponse>
{
    ...
    private void ApplyDrillDownFilters(GetBranchSurveyResponsesPaginationQuery query)
    {
        ...
        {
            AddCriteria(x => x.Answers.Any(answer =>
                answer.QuestionId == query.QuestionId.Value));
        }
